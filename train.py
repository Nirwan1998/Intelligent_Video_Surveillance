...
store_image = []
train_path = r'D:\ML_Projects\Intelligent Surveillance\train'
fps = 5
...
'''Store the store_image list in a numpy file for "training.npy:'''    
...
'''Create spatial auto-encoder architecture:'''
model = Sequential()
